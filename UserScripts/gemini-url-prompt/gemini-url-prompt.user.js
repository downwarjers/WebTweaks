...
(function() {
        ...
        show: (message) => {
            ...
            if (!overlay) {
                ...
                Object.assign(overlay.style, {
                    ...
                    color: 'white', fontSize: '24px', fontFamily: 'sans-serif',
                    pointerEvents: 'all', backdropFilter: 'blur(2px)'
                });
    ...
    function getTaskParams() {
        ...
        return {
            ...
            isTemp: params.has('temp') ? (params.get('temp') === 'true' || params.get('temp') === '1') : CONFIG.defaultTemp,
    ...
    function handleRedirectIfNeeded(settings) {
        if (settings.forceNew && window.location.pathname !== '/app') {
            ...
            UI.show('正在切換至新對話...');
            setTimeout(() => { window.location.href = 'https://gemini.google.com/app'; }, 500);
            return true;
        }
        return false;
    }
